...
export MAIN_PLATFORMS='declare -A main_platforms=( [attiny]="attiny:avr:1.0.0" )'
...
echo -n "ATtiny84: "
DEPENDENCY_OUTPUT=$(arduino --install-boards arduino:avr:ATtiny84 2>&1)
